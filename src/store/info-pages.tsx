...
export const About = () => (
  <section className="page narrow">
    ...
    <p className="lead">Stitches &amp; Stories — маленькая мастерская вещей с вышивкой.</p>
    <p>
      Здесь рождаются разнообразные изделия с вышивкой — от небольших аксессуаров до вещей для дома
      и особенных подарков. За рисунком, оттенком нитей и каждым стежком — внимание к деталям и
  ...
  <section className="page narrow">
    ...
    <ol className="steps">
      <li>
        ...
        <p>Войдите в аккаунт, добавьте понравившиеся изделия в корзину и отправьте заявку.</p>
      </li>
      <li>
